...
function buffdame() {
	...
	function an94() {
        ...
        h5gg.editAll('909035012', 'I32'); 
        h5gg.clearResults();
    }

	function m1887() {
        h5gg.clearResults();
        h5gg.searchNumber('909000033','I32','0x100000000', '0x200000000');
	...
	function m1014() {
        h5gg.clearResults();
        h5gg.searchNumber('909040009','I32','0x100000000', '0x200000000');
        h5gg.editAll('909000081', 'I32'); 
        h5gg.clearResults();
    }

	function xm8() {
        h5gg.clearResults();
        h5gg.searchNumber('909034012','I32','0x100000000', '0x200000000');
        h5gg.editAll('909000085', 'I32'); 
        h5gg.clearResults();
    }
	...
	function ak() {
        h5gg.clearResults();
        h5gg.searchNumber('909034013','I32','0x100000000', '0x200000000');
        h5gg.editAll('909000063', 'I32'); 
        h5gg.clearResults();
    }
...
function so01() {
	...
	alert("Speed X50 Enable ⚠");
}
function so03() {
    h5gg.editAll('4397530849764387586', 'I64');
	alert("Done Reset Speed ✔");
...
function so89() {
	...
	alert("Speed X10 Enable ⚠");
}
function so06() {
    h5gg.clearResults();
    h5gg.searchNumber('4397530849764387586', 'I64', '0x100000000', '0x200000000');
    h5gg.editAll('4397530849758414897', 'I64');
	alert("Speed X2 Enable ⚠");
}
